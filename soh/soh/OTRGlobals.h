...
// MOD_ACTION8/9 are aliases mapped to modifier buttons to provide two extra configurable mod actions without
// expanding controller bit width.
#define BTN_CUSTOM_MOD_ACTION8 BTN_CUSTOM_MODIFIER1
#define BTN_CUSTOM_MOD_ACTION9 BTN_CUSTOM_MODIFIER2
