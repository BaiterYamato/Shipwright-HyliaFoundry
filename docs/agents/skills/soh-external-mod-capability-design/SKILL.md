...
description: Design and implement Ship of Harkinian external-mod capabilities for API v4 with runtime safety and deterministic behavior. Use when adding new data-driven actions, schema fields, runtime subsystems, or capability-gated files in ExternalModManager and related runtimes.
---

# SOH External Mod Capability Design (v4)
...
## Reference
- Read `references/design-checklist-v4.md`.
