...
## [PLN-20260225-0019] Fix pistol reticle visibility and C-Down hold put-away behavior
- createdUtc: 2026-02-25T23:03:19Z
- status: in_progress
- scope: engine
- summary: Resolve missing pistol reticle in selected mode and make C-Down/down-arrow hold prioritize put-away instead of charging shot in aim-select flow.
- milestones:
  1. Triage first blocker in input/reticle runtime paths
  2. Patch slot-hold/toggle ordering and fire-injection guards in Player_ProcessItemButtons
  3. Patch reticle candidate/visibility resolution for pistol selected context
  4. Build + targeted validation and append plan update
- tags: external-mods, pistol, aim-select, reticle, input, api-v4
- refs:
  - soh/src/overlays/actors/ovl_player_actor/z_player.c
  - soh/soh/Enhancements/external-mods/ExternalModManager.cpp
  - x64/Release/mods/pistol_hitscan_demo/camera/camera_profiles.json
  - x64/Release/logs/Ship of Harkinian.log
